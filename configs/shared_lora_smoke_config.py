...
OUT = ROOT / "outputs/publishable_v2/shared_lora_biocot/smoke"


@dataclass
class SharedLoRASmokeConfig(BioCOT_v3_2_Config):
    ...
    oct_frames: int = 2
    colposcopy_images: int = 1
    vit_batch_size: int = 4
    ...
    colpo_encoder_pretrained: bool = False
